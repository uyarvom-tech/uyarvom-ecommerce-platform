          ...
          <AppleReveal delay={600}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Button
                ...
                asChild
              >
                <Link href="/?tab=ai-match">AI Kitchen Match</Link>
              </Button>
            </div>
          </AppleReveal>
      ...
      <ScrollStack className="">
        {showcaseCategories.map((category, index) => {
          ...
          return (
            ...
            >
              <Link href={`/?category=${category.slug}`} className="block w-full h-full cursor-pointer group relative z-10">
        ...
        >
          <Link href="/hero" className="block w-full h-full cursor-pointer group relative z-10">
            <div className="text-center h-full flex flex-col justify-center transition-transform duration-300 group-hover:scale-105 relative z-10">
              <ScrollFloat
                animationDuration={1}
                ease="back.inOut(2)"
