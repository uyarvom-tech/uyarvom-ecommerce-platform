...
export function Footer() {
  return (
    <footer className="bg-background border-t border-border/40 overflow-hidden">
      <div className="w-full border-b border-border/10 py-16 bg-secondary/10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center md:text-left">
            {[
              ...
              <div key={i} className="space-y-4 group">
                ...
                <h5 className="text-[10px] font-bold uppercase tracking-[0.4em] text-foreground">{item.title}</h5>
                <p className="text-[9px] text-foreground/40 font-bold uppercase tracking-widest leading-relaxed max-w-[180px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid gap-20 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-12">
            <Link href="/" className="flex items-center gap-6 group">
              <div className="relative h-14 w-14 overflow-hidden border border-border/10 transition-all duration-700 group-hover:border-primary/30">
                <Image
                  src="/logos/logo.png"
                  alt="Uyarvom"
                  fill
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[8px] font-bold uppercase tracking-[0.4em] text-foreground/40 -mt-1">
                  Artisanal Heritage
                </span>
              </div>
            </Link>
